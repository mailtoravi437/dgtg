            ...
            <div className="row">
              <div className="col-sm-12 col-md-6 col-lg-6 order-md-1 order-2">
                <div className="head">
                  ...
                  <h3 className="py-5 text-md-start text-sm-center">We're a digital marketing agency that helps businesses to get found, get talked about, and grow to the next level! </h3>
        ...
        <section style={{ background: '#192238' }}>
          <div className="container p-l-5 p-md-5 p-0">
            <div className="row">
              ...
              <div className="col-sm-12 col-md-6 col-lg-6 d-flex justify-content-lg-end justify-content-md-end justify-content-center align-items-center mb-3">
